...
Neither is proved here. Their provenance, stated honestly:
  ...
  (E3) THE DRT BRIDGE (H1 of `press/f4_bridge.lean`) - that a hypothetical
       ...
       (E1) and (E2).
  (E4) MINIMUM IN-DEGREE >= 23 - carried as `hmin23`. The estate's Szekeres
       arsenal (`public/proofs/Erdos902Szekeres.lean`, f(3) >= 19 kernel-sealed
       and tight) gives >= 19 directly; the step to 23 is the same unformalized
       degree-forcing work as (E3).
