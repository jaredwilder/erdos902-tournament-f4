...
theorem no_S4_of_card_le_48 (ht : IsTournament T)
    (hasS4 : ∀ s : Finset V, s.card = 4 → ∃ u, u ∉ s ∧ ∀ w ∈ s, T u w)
    (h4 : 4 ≤ Fintype.card V) (hle : Fintype.card V ≤ 48)
    (hExt : ∀ v : V,
        (dom1 T v).card = 23 →
...
#print axioms F4.triple_ge_five
#print axioms F4.pair_ge_eleven
#print axioms F4.vertex_ge_23
#print axioms F4.exists_indeg_23_le
#print axioms F4.core_regular
#print axioms F4.core_doubly
#print axioms F4.core_hasS3
#print axioms F4.mask_admissible
#print axioms F4.bad_covered
#print axioms F4.badCount_le_sum
#print axioms F4.badSets_card_transport
#print axioms F4.repairCount_transport
#print axioms F4.admissible_transport
#print axioms F4.hasS3_transport
#print axioms F4.no_S4_of_card_le_48
